...
def ctg3_part_load_test_data(request):
    return request.param


def test_part_load_performance_for(ctg8, ctg8_part_load_test_data):
    site_config, cit, baro, load_percent, tol = ctg8_part_load_test_data
    ...
    ctg_input_base_load = CtgInput(ctg_operation_mode=CtgOperationMode.BASELOAD.value,
                                   ...
                                   cit=cit,
                                   baro=baro)
    performance_part_load = ctg8.get_performance(ctg_input=ctg_input_part_load)
    performance_base_load = ctg8.get_performance(ctg_input=ctg_input_base_load)
...
def test_part_load_performance_single_case(ctg8):
    site_config = '2x1'
    cit = 30
    baro = 14.7
    load_percent = 70
